...
(function ($) { // create private scope (inside you can use $ instead of jQuery)
                ...
                jQuery(this).click(function (ev) {
                    ...
                    if (false == jQuery.data($this.get(0), "simpleDatepicker").hasDatepicker) {
                        ...
                        if (initialDate && dateRegEx.test(initialDate)) {
                            //var chosendate = new Date(initialDate); //mdy

                            splittedDate = initialDate.split('/');
                            var chosendate = new Date(splittedDate[2], parseInt(splittedDate[1]) - 1, splittedDate[0]); //dmy
    ...
    jQuery.fn.simpleDatepicker.formatOutput = function (dateObj) {
        //return (dateObj.getMonth() + 1) + "/" + dateObj.getDate() + "/" + dateObj.getFullYear(); //mdy
        return dateObj.getDate() + "/" + (dateObj.getMonth() + 1) + "/" + dateObj.getFullYear(); //dmy
    };
