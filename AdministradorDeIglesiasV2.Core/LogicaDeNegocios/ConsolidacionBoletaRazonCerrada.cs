...
{
    public partial class ConsolidacionBoletaRazonCerrada
    {
        ...
        static public List<RegistroBasico> Obtener()
        {
            ...
            if (registros == null)
            {
                registros = (from o in SesionActual.Instance.getContexto<IglesiaEntities>().ConsolidacionBoletaRazonCerrada
