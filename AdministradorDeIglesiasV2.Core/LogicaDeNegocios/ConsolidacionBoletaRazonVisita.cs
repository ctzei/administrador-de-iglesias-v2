...
{
    public partial class ConsolidacionBoletaRazonVisita
    {
        ...
        static public List<RegistroBasico> Obtener()
        {
            ...
            if (registros == null)
            {
                registros = (from o in SesionActual.Instance.getContexto<IglesiaEntities>().ConsolidacionBoletaRazonVisita
